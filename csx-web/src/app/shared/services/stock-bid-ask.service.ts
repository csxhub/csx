...
export class StockBidAskService {

  constructor(private http:HttpClient) { } ///stockbidask/{code}/{side}

  getAllByCode(code: string,side: string): Observable<StockBidAsk[]> {  
    return this.http.get<StockBidAsk[]>(URL_API+ '/csx/stock/stockbidask/' + code+'/'+ side);  
  }  
