...
import csxdddocker.model.Trader;
...
public class TraderController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<Trader> getById(@PathVariable("id") long id) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Trader> update(@PathVariable(value = "id") Long id, @RequestBody Trader objIn) {
        try {
